...
mod api;
mod state;
use api::{add_todo, delete_todo, emit_todos, update_todo};
    ...
    fn update(&mut self, _ctx: &Context<Self>, msg: Self::Message) -> bool {
        match msg {
            ...
            Msg::Edit((idx, edit_value)) => {
                ...
                update_todo(self.state.entries[idx].clone());
            }
            Msg::Remove(idx) => {
                delete_todo(self.state.entries[idx].id.clone());
